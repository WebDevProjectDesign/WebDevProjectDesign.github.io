1.Folder "gallery" zawiera skrypt wraz z przkładową stroną. Jest to skrypt, który obsługuje galerię zdjęć w stylu lightbox jednak w całości napisany jest czystym javascript.
